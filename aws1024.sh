...
echo "正在下载1T版脚本"
    wget https://raw.githubusercontent.com/langren1353/awspro/master/aws.py -O /root/.awsll/aws1024.py
...
echo "正在下载管理脚本"
    wget https://raw.githubusercontent.com/langren1353/awspro/master/ll.sh
    chmod +x ll.sh
